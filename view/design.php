<?php
  ...
  if(isset($img_design_user) && is_array($img_design_user) && count($img_design_user) > 0){
  ...
  $html_product_design='';
  if(isset($product_design) && is_array($product_design) && count($product_design) > 0){
          ...
          <div class="design-main">
            <div class="design-right">
              <div class="custom-box">
                ...
                <form action="index.php?pg=design" method="post" enctype="multipart/form-data" id="uploadForm">
                <div class="design-upload">   
                    <input name="img_design" type="file" accept="image/*" required id="fileInput"/>
                    <button type="submit" name="design_upload" id="uploadBtn"><i class="fas fa-upload"></i></button>        
                </div>
                </form>
                <div class="custom-design-icon">
                  <div class="custom-design-item">
                    <?php 
                    if($html_img_design_user != ''){
                      echo $html_img_design_user;
                    } else {
                      echo '<p style="color: #666; font-size: 14px; padding: 10px;">Chưa có ảnh nào. Hãy upload ảnh của bạn!</p>';
                    }
                    ?>
                  </div>
                </div>
                ...
                <div class="custom-design-icon">
                  <div class="custom-design-item">
                    <?php 
                    if($html_product_design != ''){
                      echo $html_product_design;
                    } else {
                      echo '<p style="color: #666; font-size: 14px; padding: 10px;">Chưa có lịch sử thiết kế. Hãy thiết kế và lưu!</p>';
                    }
                    ?>
                  </div>
                </div>
