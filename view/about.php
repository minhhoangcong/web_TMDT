        ...
        <div class="banner-image">
          ...
          <div class="banner-content">
            <div class="banner-content-desc">
              "Phong cách sinh viên – Chất riêng UTH! UTHshop - Nơi sinh viên tìm thấy phong cách của chính mình."
            </div>
          </div>
        </div>
      </div>
      ...
      <section class="intro">
        <div class="container">
          ...
          <div class="intro-content">
            <p class="intro-desc">
              UTHshop là website thương mại điện tử được phát triển bởi Nhóm 5 – Đại học Giao thông Vận tải TPHCM (UTH). 
              Dự án hướng đến việc cung cấp nền tảng mua sắm trực tuyến thân thiện, hiện đại và phù hợp với phong cách 
              năng động của sinh viên. Tại đây, người dùng có thể dễ dàng tìm kiếm và lựa chọn những sản phẩm thời trang 
              trẻ trung, cập nhật xu hướng mới nhất. Đặc biệt, UTHshop cho phép khách hàng có thể tự thiết kế mẫu áo thun 
              theo ý muốn của mình, tạo nên những sản phẩm độc đáo và cá tính riêng.
            </p>
