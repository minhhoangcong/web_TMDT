...
<html lang="en">
  <head>
    ...
    <meta name="description" content="UTHshop - Website thương mại điện tử của Nhóm 5, Đại học Giao thông Vận tải TPHCM. Phong cách sinh viên – Chất riêng UTH!" />
    <meta name="keywords" content="UTHshop, áo thun sinh viên, thời trang UTH, Giao thông Vận tải" />
    <title>UTHshop - Phong cách sinh viên – Chất riêng UTH!</title>
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.6.4/jquery.min.js" 
            onerror="console.warn('jQuery failed to load')"></script>
    <link
      rel="stylesheet"
      type="text/css"
