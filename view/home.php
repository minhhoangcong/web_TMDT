      ...
      <section class="customer">
        <div class="customer-main">
          ...
          <div class="customer-content">
            ...
            <div class="customer-title">KHÁCH HÀNG NÓI GÌ VỀ SẢN PHẨM CỦA UTHshop</div>
            <p class="customer-desc">
              "Cảm ơn UTHshop đã giúp mình tậu được những sản phẩm áo thun chất lượng. Đối với mình
            ...
            <div class="customer-info">
              ...
              <div class="customer-member">Khách hàng mua áo tại UTHshop</div>
